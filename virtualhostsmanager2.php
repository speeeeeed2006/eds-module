...
if ($apache_version < 2448) {
	...
	echo '<div class="alert alert-warning text-center" style="margin:10px 20px 5px 20px; ">You need Apache 2.4.48 or newer. Visit the <a href="https://warehouse.easyphp.org/">warehouse</a> for new versions.</div>';
} else {
